...
public class UpdateSaleCommandValidator : AbstractValidator<UpdateSaleCommand>
{
    public UpdateSaleCommandValidator()
    {
        ...
        RuleFor(x => x.Items)
            ...
            .ForEach(item =>
            {
                item.SetValidator(new UpdateSaleCommandItemValidator());
            });
    }
}

public class UpdateSaleCommandItemValidator : AbstractValidator<UpdateSaleCommandItem>
{
    public UpdateSaleCommandItemValidator()
    {
